...
public class TutorialManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject qoutaArrow;
    ...
    private bool interactionMadeInactive = false;

    private float timeMissionWait = 3f;

    private void Awake()
    {
        tutorials = new string[tutorialStringTable.GetTable().Count];
    ...
    public void CurrentTutorial()
    {
        ...
        switch (tutorialIndex)
        {
            ...
            case 8://See how those scores add up?
                ...
                NextTutTimer(7);
                break;
            case 9://The quota is a minimum score that you need to reach for your Biodiversity, 
                //Appeal and Carbon scores before the week ends.
                qoutaArrow.SetActive(true);
                NextTutTimer(7);
                break;
            case 10://You can hover over plants in your book to get extra information, you can also get 
                //interesting facts about the plant at the bottom right when selecting it.
                qoutaArrow.SetActive(false);
                NextTutTimer(12);
                break;
            case 11://Take a look at these weekly missions and try to complete one to get extra money.
                if (!weekPassed)
                {
                ...
                break;
            case 12://You can change the speed of time with these buttons
                ...
                break;
            case 13://Do you see the green particles? It means the plants are sick. 
                ...
                break;
            case 14://Do you see the red particles? It means the plants have attracted invasive species. 
                ...
                break;
            case 15://Play as long as you can by passing the increasing weekly quota (biodiversity, appeal, 
                ...
                NextTutTimer(7);
                break;
            case 16://This is the end of the tutorial, good luck!
                if (!interactionMadeInactive)
                {
                    EventManager.currentManager.AddEvent(new ActivateInteractionState(PlayerInteractionState.inactive));
                    interactionMadeInactive = true;
                }
                NextTutTimer(4);
                break;
            case 17:
    ...
    private void LoadStrings(StringTable stringTable)
    {
        ...
        foreach (string tutorialText in tutorials)
        {
            int index = tutorials.ToList().IndexOf(tutorialText);
